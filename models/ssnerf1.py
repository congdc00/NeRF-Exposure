...
class SSNeRF1Model(BaseModel):
    ...
    def forward_(self, rays):
        ...
        #Độ sáng
        comp_rgb = comp_rgb*new_brightness #+ self.background_color * (1.0 - opacity) 
        ...
        if self.training:
            ...
            content = []
            headers = ["brightness", "rgb", "rgb*brightness","weights", "new_brightness","volume_rendering rgb", "volume_rendering rgb*brightness"]
            k = 0
